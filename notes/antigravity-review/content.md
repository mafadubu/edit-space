...
홈페이지를 완성했다면 이제 실제로 배포해 볼 차례입니다. 개인 포트폴리오 용도라면 굳이 도메인을 바로 구입하지 않아도 됩니다. 간단하게는 GitHub에 업로드해 정적 페이지로 배포하는 방법만으로도 충분합니다. 물론 저장소 이름이나 주소가 그대로 URL에 노출되기 때문에, 저처럼 ‘mafadubu’ 같은 요상한 이름을 넣는 부끄러운 짓을 하지 않으면 더 좋겠습니다. <span class="tip-container" tabindex="0"><span class="tip-badge">Tip</span><span class="tip-content"><span>GitHub는 코드를 저장하고 관리하는 온라인 저장소로, 쉽게 말해 ‘개발자용 구글 드라이브’와 같습니다. 내가 만든 파일을 올려 두고, 수정 이력을 관리하거나 다른 사람과 협업할 수 있습니다.</span></span></span>
...
이렇게 [기획] – [디자인/개발] – [배포]의 흐름으로 전체 과정을 아주 가볍게 훑어 보았습니다. 엄밀히 말하면 QA 단계가 빠져 있지만, 저희 같은 비개발자 상남자, 상여자들은 보통 QA 정도는 배포 이후에 합니다. 물론 각 단계마다 다양한 방법이 연구되고 있으니, 더 깊게 파고 싶은 분들은 유튜브 등으로 더 깊게 파 보셔도 좋겠습니다. <span class="tip-container" tabindex="0"><span class="tip-badge">Tip</span><span class="tip-content"><span>참고로 깃허브에서 배포하게 되면 주소가 ‘아이디.github.io/저장소명’ 형식이라 다소 길고, 덜 전문적으로 보일 수 있습니다. 이 때 주소를 바꾸고 싶다면 가비아, 호스팅 등 사이트에서 도메인을 구입해야 합니다.</span></span></span>

<div class="section-header"><span class="section-number">5</span><span class="section-text">마치며</span></div>

안티그래비티는 비개발자에게 생각보다 훨씬 현실적인 도구였습니다. 우선 무엇보다 텍스트로 쉽게 작업을 요청할 수 있고, 결과물도 빠르게 도출되어 코딩 한 줄 모르는 저도 다양한 결과물을 만들어 볼 수 있다는 점이 상당히 매력적이었습니다. 

물론 진행하다보면 안티그래비티가 완벽하다고 말하기는 어려운 부분도 있었습니다. 요청이 반영이 안된다거나, 오류를 해결하지 못하는 등의 상황이 발생하면 비개발자 입장에서는 해결하기 참 까다로웠습니다. 하지만 노션을 넘어 ‘진짜 웹사이트’를 만들어 보고 싶다면 한 번쯤 시도해 볼 만한 선택지라는 생각입니다.